...
export type ParameterRange = { min: number; max: number; step: number; unit: 'mm' | '°' };
...
export function hasTemplateParameter(templateId: TemplateId, parameter: keyof KeychainParams): boolean {
